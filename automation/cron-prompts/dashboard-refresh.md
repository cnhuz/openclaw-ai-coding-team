...
1. 运行 `python3 scripts/refresh_dashboard.py --registry-path tasks/registry.json --handoffs-dir handoffs --exec-logs-dir data/exec-logs --sessions-root __OPENCLAW_HOME__/agents --research-root __OPENCLAW_HOME__/workspace-aic-researcher/data/research --skills-root __OPENCLAW_HOME__/workspace-aic-researcher/data/skills --output data/dashboard.md`

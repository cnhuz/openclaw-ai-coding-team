...
3. 读 `USER.md`
4. 读 `MEMORY.md`
5. 优先用 `python3 scripts/query_task_registry.py --path tasks/registry.json --view captain --format md` 查看活跃项；若要聚焦阻塞，再加 `--blocked-only`
...
- 高频信息提升到 `MEMORY.md`
- 详细过程优先写入当日日志 `memory/YYYY-MM-DD.md`
